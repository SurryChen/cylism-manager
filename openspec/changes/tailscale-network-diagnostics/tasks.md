...
- [ ] 1.5 Run `gofmt` and focused Go tests; submit security scan records for changed business files.
...
- [ ] 2.4 Run focused frontend tests and security scan records for changed business files.
...
- [ ] 3.4 Present all validation results for approval before archiving the OpenSpec change.
