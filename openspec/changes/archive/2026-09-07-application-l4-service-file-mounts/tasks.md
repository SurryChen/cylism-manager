...
- [x] 2.2 Extend endpoint APIs and synchronization to distinguish HTTP Ingress from Service exposure while preserving legacy endpoints.
- [x] 2.3 Add Service status reporting for externally allocated addresses and ports.
- [x] 2.4 Add backend tests for authorization, validation and backward compatibility.
...
- [x] 3.3 Adapt endpoint and application summary views for HTTP Ingress versus Service exposure.
