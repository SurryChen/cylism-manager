...
Control-plane reads that can overlap because of refresh, target change, tab change or component disposal SHALL accept request options and SHALL cancel or ignore superseded results.
