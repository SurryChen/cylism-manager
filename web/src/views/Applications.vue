...
async function openStacks() { await router.push({ path: '/applications/stacks', query: { project_id: workspaceProjectID.value, environment_id: workspaceEnvironmentID.value } }) }
