...
.dashboard-metrics { grid-template-columns: repeat(6, minmax(0, 1fr)); }.dashboard-metrics .metric { min-height: 96px; padding: 16px 18px; }.dashboard-metrics .metric-value { font-size: 26px; }.dashboard-workspace { display: grid; grid-template-columns: minmax(0, 7fr) minmax(310px, 4fr); gap: var(--space-20); }.dashboard-primary-panel, .dashboard-activity-panel { min-width: 0; }.dashboard-workspace .card-header { align-items: flex-start; margin-bottom: 16px; }.dashboard-workspace .page-eyebrow { margin-bottom: 5px; }.panel-caption { padding: 5px 7px; border-radius: 5px; background: var(--warning-surface); color: var(--warning); font: 10px/1 var(--font-mono); }.dashboard-empty-state { min-height: 230px; }.metric-version { font-size: 15px !important; }
@media (max-width: 960px) { .dashboard-workspace { grid-template-columns: 1fr; }.dashboard-activity-panel { min-height: 0; } }
@media (max-width: 700px) { .cluster-strip { align-items: flex-start; flex-direction: column; gap: 16px; }.cluster-strip-stats { grid-template-columns: repeat(3, minmax(0, 1fr)); }.dashboard-metrics { grid-template-columns: repeat(2, minmax(0, 1fr)); }.dashboard-metrics .metric { min-height: 88px; }.dashboard-workspace { gap: var(--space-16); } }
</style>
