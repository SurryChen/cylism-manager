...
function templatePayload() { const form = templateForm.value; return { name: form.name, description: form.description, enabled: form.enabled, spec: { image: form.image, registry_id: form.registry_id, container_port: form.container_port, replicas: form.replicas, node_name: form.node_name, volumes: form.volumes, resources: { requests_cpu: `${form.resources.requests_cpu}${form.resources.requests_cpu_unit}`, requests_memory: `${form.resources.requests_memory}${form.resources.requests_memory_unit}`, limits_cpu: `${form.resources.limits_cpu}${form.resources.limits_cpu_unit}`, limits_memory: `${form.resources.limits_memory}${form.resources.limits_memory_unit}` }, health: form.health, service: { port: form.service.port, target_port: form.service.target_port } } } }
