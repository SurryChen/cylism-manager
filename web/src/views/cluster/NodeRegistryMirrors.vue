<template>
  <div>
    <TabbedWorkspaceCard class="rule-workspace" data-testid="node-registry-mirror-workspace">
      ...
      <template #actions><div class="btn-group workspace-actions"><button class="btn" data-testid="open-node-config" @click="openNodeConfig">查看节点配置</button><a class="btn proxy-management-link" href="#/cloud-services/registry?tab=registry-proxy">管理 Registry Proxy</a><button class="btn btn-primary" @click="openCreate">+ 新建镜像源</button></div></template>
