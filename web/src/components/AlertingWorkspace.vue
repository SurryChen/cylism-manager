...
.alert-settings-overlay{z-index:1500;align-items:center;justify-content:center}.alert-settings-modal{width:min(680px,100%);max-height:calc(100dvh - 32px)}.check-row{display:flex;gap:8px;margin-top:var(--space-16);color:var(--text-secondary);font-size:13px}.email-fields{margin-top:var(--space-16)}
</style>
