...
<style scoped>
.disk-growth-heading{display:flex;align-items:center;justify-content:space-between;gap:var(--space-16)}.disk-growth-heading h2{margin:0;color:var(--text-primary);font-size:16px}.disk-growth-heading p,.card-header p{margin:5px 0 0;color:var(--text-secondary);font-size:12px}.disk-growth-controls{display:flex;align-items:end;flex-wrap:wrap;gap:8px}.disk-growth-controls label{display:grid;gap:4px;color:var(--text-secondary);font-size:11px;font-weight:700}.disk-growth-controls select{min-width:130px;min-height:34px;padding:6px 28px 6px 9px;font-size:11px}.disk-growth-grid{display:grid;margin-top:var(--space-20);grid-template-columns:repeat(2,minmax(0,1fr));gap:var(--space-16)}.disk-growth-table td{vertical-align:top}.disk-growth-meta{display:block;margin-top:3px;color:var(--text-secondary);font-size:11px;line-height:1.35}@media(max-width:760px){.disk-growth-heading{align-items:flex-start;flex-direction:column}.disk-growth-controls{width:100%}.disk-growth-controls label{flex:1}.disk-growth-controls select{width:100%;min-width:0}.disk-growth-grid{grid-template-columns:1fr}}
</style>
