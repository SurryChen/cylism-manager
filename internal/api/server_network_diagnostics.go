...
func (h *ServerHandler) NetworkDiagnostics(c *gin.Context) {
...
func (h *ServerHandler) collectNetworkSnapshot(server *model.Server) (serverNetworkDiagnostic, error) {
...
func (h *ServerHandler) collectNetworkLinks(servers []model.Server, snapshots []serverNetworkDiagnostic) []tailnetLinkDiagnostic {
...
func (h *ServerHandler) collectNetworkLink(source *model.Server, targetIP string) (tailnetLinkDiagnostic, error) {
