...
type ComponentAdapter interface {
	LoggingStatusContext(context.Context) *k8s.LoggingStatus
	InstallLoggingContext(context.Context, k8s.LoggingConfig) (*k8s.LoggingStatus, error)
	UninstallLoggingContext(context.Context) error
}
