...
func (c *Client) upsertOpsAgentConfig(config OpsAgentConfig) error {
	...
	data := map[string]string{"CYLISM_API_URL": "http://cylism-manager.default.svc:8080", "OPS_AGENT_MODEL": "openai-chat:" + config.Model, "CYLISM_API_TIMEOUT_SECONDS": "12"}
	if config.BaseURL != "" {
